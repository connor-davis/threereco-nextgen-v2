...
func (r *CollectionsRouter) DeleteRoute() routing.Route {
	responses := openapi3.NewResponses()

	responses.Set("200", &openapi3.ResponseRef{
		Value: openapi3.NewResponse().
			WithDescription("Successful collection deletion.").
	...
	return routing.Route{
		OpenAPIMetadata: routing.OpenAPIMetadata{
			...
			Description: "Delete an existing collection from the system.",
		...
		Middlewares: []fiber.Handler{
			...
			r.Middleware.Authorized([]string{"collections.delete"}),
		},
		Handler: func(c *fiber.Ctx) error {
			...
			if err := r.Services.Collections().Delete(params.Id); err != nil {
