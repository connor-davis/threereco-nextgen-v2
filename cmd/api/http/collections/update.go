...
func (r *CollectionsRouter) UpdateRoute() routing.Route {
	responses := openapi3.NewResponses()

	responses.Set("200", &openapi3.ResponseRef{
		Value: openapi3.NewResponse().
			WithDescription("Successful collection update.").
	...
	body := &openapi3.RequestBodyRef{
		Value: openapi3.NewRequestBody().
			WithRequired(true).
			WithDescription("Payload to update an existing collection.").
			WithContent(openapi3.Content{
				"application/json": openapi3.NewMediaType().
	...
	return routing.Route{
		...
		Handler: func(c *fiber.Ctx) error {
			...
			var payload models.UpdateCollectionPayload
			...
			if err := r.Services.Collections().Update(params.Id, payload); err != nil {
