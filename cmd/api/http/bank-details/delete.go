...
func (r *BankDetailsRouter) DeleteRoute() routing.Route {
	responses := openapi3.NewResponses()

	responses.Set("200", &openapi3.ResponseRef{
		Value: openapi3.NewResponse().
			WithDescription("Successful bank details deletion.").
	...
	return routing.Route{
		OpenAPIMetadata: routing.OpenAPIMetadata{
			...
			Description: "Delete existing bank details from the system.",
		...
		Handler: func(c *fiber.Ctx) error {
			...
			if err := r.Services.BankDetails().Delete(params.Id); err != nil {
