...
export const Route = createFileRoute('/_auth/transactions/$id/edit')({
  component: () => (
    ...
    <div className="flex flex-col w-full h-full bg-popover border-t p-3 gap-3">
      <div className="flex items-center justify-between w-full h-auto">
        <div className="flex items-center gap-3">
          ...
          <Label className="text-lg">Edit Transaction</Label>
        </div>
                  ...
                  <Card className="border-dashed">
                    ...
                    <CardFooter>
                      <div className="grid grid-cols-2 w-full h-auto gap-5 items-center">
                        ...
                        <Button className="w-full">Update Transaction</Button>
                      </div>
                    </CardFooter>
                  </Card>
                </div>
